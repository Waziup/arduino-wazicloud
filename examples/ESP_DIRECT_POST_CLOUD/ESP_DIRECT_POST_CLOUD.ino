...
void loop() {
  ...
  if (WiFi.status() == WL_CONNECTED) { //CHECK WIFI CONNECTION STATUS
    ...
    http.addHeader("Content-Type", "text/plain;charset=utf-8");  //SPECIFY CONTENT TYPE
 
    int httpCode = http.POST("20");   //SENDING VALUES TO THE CLOUD - e.g sending a dummy value of 20
